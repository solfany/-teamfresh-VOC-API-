...
function ConfirmCarrier() {
  ...
  const [submittedAtFaultParty, setSubmittedAtFaultParty] = useState("");
  const [submittedFaultDetails, setSubmittedFaultDetails] = useState("");
  ...
  const handleSubmit = (e) => {
    ...
    setSubmittedAtFaultParty(atFaultParty);
    setSubmittedFaultDetails(faultDetails);
    // 입력 항목 초기화
    setAtFaultParty("");
    setFaultDetails("");
    setPenaltyDetails("");
            ...
            <Form onSubmit={handleSubmit}>
              <Form.Group controlId="carrierSelection">
                ...
                >
                  ...
                  <option value="운송사1">운송사1</option>
                  <option value="운송사2">운송사2</option>
                </Form.Control>
              </Form.Group>
              ...
              <Form.Group controlId="driverSelection">
                ...
                >
                  <option value="">선택하세요</option>
                  <option value="기사님1">기사님1</option>
                  <option value="기사님2">기사님2</option>
                </Form.Control>
              </Form.Group>

              <Form.Group controlId="managerCode">
                <Form.Label>담당자 코드 입력</Form.Label>
                <Form.Control
                  type="text"
              ...
              <br />
              {selectedCarrier && selectedDriver && managerCode ? (
